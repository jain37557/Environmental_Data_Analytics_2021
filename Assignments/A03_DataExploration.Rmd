...
> Answer: Since there is nicotine in it idk? 
...
summary(Neonics$Effect.Measurement)
```
...
```{r}
table(Neonics$Species.Scientific.Name)
sort(table(Neonics$Species.Scientific.Name),decreasing = TRUE)
```
